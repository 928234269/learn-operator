...
import (
	...
	appv1 "github.com/928234269/learn-operator/pkg/apis/app/v1"
...
func (r *ReconcileLearn) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	if err != nil && errors.IsNotFound(err) {
		...
		reqLogger.Info("Creating a new Deployment", "Deployment.Namespace", dep.Namespace, "Pod.Name", dep.Name)
